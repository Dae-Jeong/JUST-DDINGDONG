 ...
 *
 * 프론트엔드 애플리케이션이 다른 도메인에서 API를 호출할 수 있도록 허용하는 정책을 정의합니다.
 * 환경별로 다른 Origin을 허용할 수 있도록 설정되어 있습니다.
 */
@Configuration
public class CorsConfig {
     ...
     *
     * 개발 환경에서는 localhost의 다양한 포트를 허용하고,
     * 운영 환경에서는 application.properties에서 설정된 도메인만 허용합니다.
     *
